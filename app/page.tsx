...
export default function Home() {
	...
	return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center">
            ...
            {/* Hero Section */}
            <section className="container text-center py-24 space-y-8">
            ...
            <section className="container py-16">
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 items-center justify-center px-10">
                    <Card>
                        <CardContent className="flex flex-col items-center text-center">
                            <ClipboardList className="h-8 w-8 text-primary mb-4 mt-4" />
                    ...
                    <Card>
                        <CardContent className="flex flex-col items-center text-center">
                            <Users className="h-8 w-8 text-primary mb-4 mt-4" />
                    ...
                    <Card>
                        <CardContent className="flex flex-col items-center text-center">
                            <Activity className="h-8 w-8 text-primary mb-4 mt-4" />
                    ...
                    <Card>
                        <CardContent className="flex flex-col items-center text-center">
                            <BarChart className="h-8 w-8 text-primary mb-4 mt-4" />
                    ...
                    <Card>
                        <CardContent className="flex flex-col items-center text-center">
                            <DollarSign className="h-8 w-8 text-primary mb-4 mt-4" />
                    ...
                    <Card>
                        <CardContent className="flex flex-col items-center text-center">
                            <ShoppingBag className="h-8 w-8 text-primary mb-4 mt-4" />
